...
- `public/pdf.worker.min.mjs` — the `pdfjs-dist` worker script, copied here at `npm install` time by `scripts/copy-pdf-worker.js` (see [Overview](/docs/schatten-lesen/overview)).
